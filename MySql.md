# MYSql
###1.查询所有数据库
`show databases`使用这个命令可以查看所有的数据库  
###2.创建数据库
`create database renyufei`创建数据库
如果不指定编码的话默认编码就是utf8
不过我们可以使用`character set utf8`
我们可以查看默认编码`show create database renyufei`
###3.删除数据库
...
####9.4修改字段名称
`alter table student change column 原来字段名 修改后字段名 类型`
####9.5修改表名称
...
```
####时间日期相关函数
![2016123015394屏幕快照 2016-12-30 下午3.32.38.png](http://7xqmjb.com1.z0.glb.clouddn.com/2016123015394屏幕快照 2016-12-30 下午3.32.38.png)

####字符串相关函数
![2016123052459屏幕快照 2016-12-30 下午3.34.11.png](http://7xqmjb.com1.z0.glb.clouddn.com/2016123052459屏幕快照 2016-12-30 下午3.34.11.png)
####数学相关函数
![20161230116屏幕快照 2016-12-30 下午3.35.10.png](http://7xqmjb.com1.z0.glb.clouddn.com/20161230116屏幕快照 2016-12-30 下午3.35.10.png)
